    ...
    <script type="text/javascript">  
        $(function(){  
            ...
            $("#cc").combobox({     
                ...
                url:'${pageContext.request.contextPath}/account/query.html',    
                valueField:'id',      
            ...
            $("#ff").form('load',{  
                ...
                type:rows[0].type,  
                    hot:rows[0].hot,  
                'aid':rows[0].aid //EasyUI不支持account.id这种点操作，所以要加个引号  
            });  
            ...
            $("#btn").click(function(){  
                ...
                if($("#ff").form("validate")) {  
                    //调用submit方法提交数据  
                    $("#ff").form('submit', {  
                        url: '${pageContext.request.contextPath}/category/update.html', //提交时将请求传给categoryAction的update方法执行  
                        success: function(){  
                            //如果成功了，关闭当前窗口，并刷新页面  
