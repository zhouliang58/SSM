    ...
    <script type="text/javascript">  
        $(function(){  
            $('#dg').datagrid({     
                ...
                url:'${pageContext.request.contextPath}/product/query.html',  
                loadMsg:'Loading......',  
                ...
                toolbar: [{  
                    ...
                    handler: function(){  
						...
						parent.$("#win").window({
							...
							width:650,
							height:600,
							content:'<iframe src="${pageContext.request.contextPath}/product/tosave.html" frameborder="0" width="100%" height="100%"/>'
						});
                    }  
                 },'-',{  
                    iconCls: 'icon-edit',  
                    ...
                    handler: function(){  
						...
						if(rows.length == 0) {
							...
							parent.$("#win").window({
								...
								width:650,
								height:600,
								content:'<iframe src="${pageContext.request.contextPath}/product/toupdate.html" frameborder="0" width="100%" height="100%"/>'
							});
						}
                    }  
                 },'-',{  
                        ...
                        if(rows.length == 0) {  
                            ...
                            $.messager.confirm('删除的确认对话框', '您确定要删除此项吗？', function(r){  
                                if (r){  
                                    ...
                                    //2. 发送ajax请求  
                                    $.post("${pageContext.request.contextPath}/product/deleteByIds.html",{ids:ids},function(result){  
                                        if(result == "true") {  
