		...
		$(function(){
			...
			//验证数据的有效性
				...
				if(!isNaN(number) && parseInt(number)==number && number>0){ 
					...
					$.post("${pageContext.request.contextPath}/sorder/updateSorder.html", {number:number, id:pid}, function(total){		
			...
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<h1 class="logo clear fl">
						<a href="${pageContext.request.contextPath}/index.html"> <img src="${pageContext.request.contextPath}/images/logo.png" /> </a>
					</h1>
					<!-- 小购物车 -->
					<div class="minicart">
						<a class="minicart_link" href="#"> <span class="item">
								<b>${fn:length(sessionScope.forderCustom.sorders)}</b> 件/ </span> 
								<span class="price"> <b>￥${sessionScope.forderCustom.total}</b> </span> </a>
					</div>
					<!-- 小购物车结束 -->
					<!-- 搜索框 -->
			...
			<div id="shopping_cart">
				...
				<table class="data-table cart-table" cellpadding="0" cellspacing="0">
					...
					<tr lang="${sorder.pid}">
						...
						<td width="80px"><img src="${pageContext.request.contextPath}/files/${sorder.product.pic}" width="80" height="80" />
						</td>
						...
						<tbody>
							<tr>
								...
								<td class="align_right" style=""><strong>￥<span
										class="price" id="total">${sessionScope.forderCustom.total}</span>
								</strong>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="align_right" style="">￥<span class="total" id="totalAll"><strong>${sessionScope.forderCustom.total}</strong>
								</span>
								</td>
							</tr>
						</tbody>
