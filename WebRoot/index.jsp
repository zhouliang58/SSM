                ...
                <!--头部开始-->
                        <div class="top_bar clear">
                            ...
                            <ul class="top_links fr">
                                ...
                                <li><a href="#">购物车</a></li>
                                <li><a href="#">注册</a></li>
                                <li ><a href="${pageContext.request.contextPath}/user/tologin.html">登录</a></li>
                            </ul>
                            <!--头部小导航结束-->
                            <!-- logo -->
	            ...
	            <div class="products_list products_slider clear">
	                ...
	                <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
	                    <c:forEach items="${list }" var="product">
		                    <li> 
		                    	<!-- 点击图片进入商品详细页面 -->
		       		            <a href="${pageContext.request.contextPath}/product/get.html?id=${product.id}" class="product_image">
		       		            <img src="/file/${product.pic}" /><!-- /file是映射的虚拟路径 -->
		       		            </a>	       
		                        <div class="product_info">
		                            <h3><a href="#">商品名称：${product.name }</a></h3>
		                            <small>简单描述：${product.remark}</small> </div>
		                        <div class="price_info"> 
		                            <a href="${pageContext.request.contextPath}/sorder/addSorder.html?id=${product.id}"><button><span class="pr_add">添加购物车</span></button></a>
