	...
	<div class="wrapper">
				...
				<div class="top_bar clear">
					...
					<div class="minicart">
						<a class="minicart_link" href="#"> <span class="item">
								<b>0</b>件/ </span> <span class="price"> <b>￥${sessionScope.forderCustom.total}</b> </span> </a>
					</div>
					<!-- 小购物车结束 -->
					<!-- 搜索框 -->
		...
		<div class="section_container">
			...
			<div id="dd" class="action_buttonbar" style="text-align:center;">
				<form method="post" action="${pageContext.request.contextPath}/user/login.html">
					<div>
					...
					<div>
						...
						<input type="button" value="注册" onclick="window.open('${pageContext.request.contextPath}/index.jsp','_self')" style="width:60px;height:30px" />
					</div>
			   </form>
